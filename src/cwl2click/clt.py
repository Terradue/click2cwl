...
class CommandLineTool():
    ...
    def __init__(self, click2cwl):
        ...
        if self.click2cwl.get_docker() is not None:
            ...
            self._clt_class['hints'] = {'DockerRequirement': {'dockerPull': self.click2cwl.get_docker()}}
        ...
        self._clt_class['requirements'] = {'ResourceRequirement': self.click2cwl.get_requirements(),
        ...
        for index, param in enumerate(self.click2cwl.params):
            ...
            self._clt_class['inputs'][cwl_param.name] = cwl_param.to_clt_input(position=index+1)
